...
# Virtual Exim 2
## THIS IS NOT CURRENTLY PRODUCTION READY, PLEASE DO NOT INSTALL THIS!
...
```
Or this is a fresh install you can run `bash setup-web.sh` in the vexim_web directory and it will install all the tables for you (MariaDb/MySQL only).
...
## System Admin (formerly "Site Admin"):
